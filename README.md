...
Use `lein trampoline run` to do user input against the computer.  Enter moves in the form of row,col starting at 0,0 in the upper left corner.  Starting player is random but you are always :o and computer is :x.
